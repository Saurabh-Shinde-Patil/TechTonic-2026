...
function App() {
  ...
  return (
    <Router>
      <ThemeProvider>
        <div className="min-h-screen bg-white dark:bg-dark-900 text-slate-900 dark:text-white selection:bg-neon-purple/30 selection:text-white transition-colors duration-300">
