...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-dark-900 pt-12 pb-8 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h2 className="text-2xl font-orbitron font-bold neon-text-blue mb-2">
              TECHTONIC<span className="text-neon-purple neon-text-purple">2K26</span>
            </h2>
            <p className="text-gray-400 text-sm">Unleash the Ultimate Tech Arena</p>
          </div>
